...
PYTHONPATH=src python -m balance_fundraising.cli donor-campaigns
PYTHONPATH=src python -m balance_fundraising.cli donor-campaign-add --name "Майский дайджест" --type impact_digest --segment "регулярные доноры" --goal "Показать результаты месяца"
PYTHONPATH=src python -m balance_fundraising.cli donor-campaign-show <campaign_id>
PYTHONPATH=src python -m balance_fundraising.cli donor-campaign-status <campaign_id> ready_for_review
PYTHONPATH=src python -m balance_fundraising.cli donor-campaign-note <campaign_id> "Проверено вручную"
PYTHONPATH=src python -m balance_fundraising.cli donor-campaign-draft <campaign_id>
